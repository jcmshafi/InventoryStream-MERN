...
import { AiOutlineEye } from "react-icons/ai"; // Assuming AiOutlineEye is from the 'ai' package
                                                        ...
                                                        DataList.map((item,i)=>
                                                            <tr key={item._id}>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <CurrencyFormat
                                                                        value={item.GrandTotal || 0} // Display 0 if GrandTotal is null
                                                                        displayType={'text'}
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <CurrencyFormat
                                                                            value={item.ShippingCost !== null ? item.ShippingCost : 0}
                                                                            displayType={'text'}
                                                                            thousandSeparator={true}
                                                                            prefix={'$'}
                                                                        />
                                                                ...
                                                                <td>
                                                                    <p className="text-xs text-start">
                                                                    <CurrencyFormat
                                                                            value={item.VatTax !== null ? item.VatTax : 0}
                                                                            displayType={'text'}
                                                                            thousandSeparator={true}
                                                                            prefix={'$'}
                                                                        />
                                                                ...
                                                                <td>
                                                                    <p className="text-xs text-start">
                                                                    <CurrencyFormat
                                                                            value={item.OtherCost !== null ? item.OtherCost : 0}
                                                                            displayType={'text'}
                                                                            thousandSeparator={true}
                                                                            prefix={'$'}
                                                                        />
