...
const URI = "mongodb+srv://<username>:<password>@cluster0.yn9xgi5.mongodb.net/InventoryStream?retryWrites=true&w=majority";
const OPTIONS = { user: 'inventory', pass: 'inventory123', autoIndex: true };
